...
export function DeleteButton({ courseId, courseTitle }: DeleteButtonProps) {
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="mb-6 text-center text-sm text-[#4A5768]">
                Are you sure you want to delete <span className="font-medium text-[#0A1A33]">"{courseTitle}"</span>?
                <br />
