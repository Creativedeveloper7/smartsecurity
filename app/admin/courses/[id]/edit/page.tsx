    ...
    const fetchCourse = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          expandedDescription: course.expandedDescription || "",
          idealAudience: course.idealAudience || "",
          deliveryFormat: course.deliveryFormat || "Workshop / Custom",
          duration: course.duration || "Customizable",
          price: course.price || "On request",
          image: course.image || "",
          published: course.published || false,
        });

        setKeyOutcomes(course.keyOutcomes && course.keyOutcomes.length > 0 
          ? course.keyOutcomes 
          : [""]
        );
        ...
        if (course.image) {
          ...
          if (course.image.includes("/uploads/") || course.image.includes("supabase")) {
    ...
    return (
      <div className="min-h-screen bg-[#F3F4F6] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#4A5768]">Loading course...</p>
        </div>
      </div>
    );
  }
